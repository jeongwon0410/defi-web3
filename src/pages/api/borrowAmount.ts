...
export async function DAIBorrowAmount(): Promise<string | undefined> {
...
export async function USDCBorrowAmount(): Promise<string | undefined> {
...
export async function USDTBorrowAmount(): Promise<string | undefined> {
...
export async function WBTCBorrowAmount(): Promise<string | undefined> {
...
export async function LINKBorrowAmount(): Promise<string | undefined> {
...
export async function AAVEBorrowAmount(): Promise<string | undefined> {
...
export async function EURSBorrowAmount(): Promise<string | undefined> {
...
export async function WETHBorrowAmount(): Promise<string | undefined> {
