...
export async function DAIBorrow(tokenSupply: string) {
...
export async function USDTBorrow(tokenSupply: string) {
...
export async function USDCBorrow(tokenSupply: string) {
...
export async function WBTCBorrow(tokenSupply: string) {
...
export async function LINKBorrow(tokenSupply: string) {
...
export async function AAVEBorrow(tokenSupply: string) {
...
export async function EURSBorrow(tokenSupply: string) {
...
export async function WETHBorrow(tokenSupply: string) {
