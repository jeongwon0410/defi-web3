...
export default function BalanceHeader({
  ...
  return (
    <div className="relative top-4 -z-10 flex  justify-between rounded-t-[0.8rem] bg-gradient-to-r from-[#83AD82]/[28%] via-[#83AD82]/[9%] to-[#FFFFFF]/[1%] px-[3.37rem] pb-[2.4rem] pt-[1.8rem]">
